    ...
    <main class="container">
      ...
      <div class="info">
        <div class="product-image">
          <img :src=product.image class="img-cover" alt="">
        </div>

        <div class="product-description">
          <div id="album_time" title="Продолжительность: ">{{ product.time }}+</div>
        ...
        <div class="product-about">
          <h4>Описание альбома {{ product.author }}: "{{ product.title }}"</h4>
